...
We also have [a JSON Schema](../../github.com/test_generation/configuration-schema.json) that can be used by IDEs/editors with the Language Server Protocol (LSP) to perform intelligent suggestions, i.e.:
...
Below we can see a trimmed down example taken from the OpenAPI Petstore [example](../../github.com/test_generation/examples/petstore-expanded/stdhttp/api/petstore.gen.go):
...
To implement this HTTP server, we need to write the following code in our [`api/impl.go`](../../github.com/test_generation/examples/minimal-server/stdhttp/api/impl.go):
...
To implement this HTTP server, we need to write the following code in our [`api/impl.go`](../../github.com/test_generation/examples/minimal-server/chi/api/impl.go):
...
To implement this HTTP server, we need to write the following code in our [`api/impl.go`](../../github.com/test_generation/examples/minimal-server/gorillamux/api/impl.go):
...
To implement this HTTP server, we need to write the following code in our [`api/impl.go`](../../github.com/test_generation/examples/minimal-server/echo/api/impl.go):
...
To implement this HTTP server, we need to write the following code in our [`api/impl.go`](../../github.com/test_generation/examples/minimal-server/fiber/api/impl.go):
...
For a complete example see [`examples/only-models`](../../github.com/test_generation/examples/only-models).
...
Check out [the import-mapping/samepackage example](../../github.com/test_generation/examples/import-mapping/samepackage) for the full code.
...
Check out [the import-mapping/multiplepackages example](../../github.com/test_generation/examples/import-mapping/multiplepackages/) for the full code.
...
Check out [the overlay example](../../github.com/test_generation/examples/overlay/) for the full code, and some more complex examples.
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xgotype/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xgotypeskipoptionalpointer/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xgoname/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xgotypename/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xgojsonignore/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xoapicodegenextratags/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xenumvarnames/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xdeprecatedreason/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xorder/).
...
You can see this in more detail in [the example code](../../github.com/test_generation/examples/extensions/xoapicodegenonlyhonourgoname).
...
To see how this can work, check out the [authenticated API example](../../github.com/test_generation/examples/authenticated-api/echo).
...
For more details of what the resulting code looks like, check out [the test cases](../../github.com/test_generation/internal/test/outputoptions/name-normalizer/).

## Examples

The [examples directory](../../github.com/test_generation/examples) contains some additional cases which are useful examples for how to use `oapi-codegen`, including how you'd take the Petstore API and implement it with `oapi-codegen`.

You could also find some cases of how the project can be used by checking out our [internal test cases](../../github.com/test_generation/internal/test) which are real-world usages that make up our regression tests.
...
For more info, check out [the example code](../../github.com/test_generation/examples/anyof-allof-oneof/).
...
<p align="center">
	<a href="https://elastic.co?utm_source=oapi-codegen+repo&utm_medium=github+sponsorship">
		<picture>
		  <source media="(prefers-color-scheme: light)" srcset="../../github.com/test_generation/.github/sponsors/elastic-light.svg">
		  <source media="(prefers-color-scheme: dark)" srcset="../../github.com/test_generation/.github/sponsors/elastic-dark.svg">
		  <img alt="Elastic logo" src="../../github.com/test_generation/.github/sponsors/elastic-dark.svg" height="100px">
		</picture>
	</a>
</p>
...
<p align="center">
	<a href="https://www.devzero.io/lp/dev-environment?utm_campaign=github&utm_source=oapi-codegen%20repo&utm_medium=github%20sponsorship">
		<picture>
		  <source media="(prefers-color-scheme: light)" srcset="../../github.com/test_generation/.github/sponsors/devzero-light.svg">
		  <source media="(prefers-color-scheme: dark)" srcset="../../github.com/test_generation/.github/sponsors/devzero-dark.svg">
		  <img alt="DevZero logo" src="../../github.com/test_generation/.github/sponsors/devzero-dark.svg" height="100px">
		</picture>
	</a>
</p>
...
<p align="center">
	<a href="https://speakeasy.com?utm_source=oapi-codegen+repo&utm_medium=github+sponsorship">
		<picture>
		  <source media="(prefers-color-scheme: light)" srcset="../../github.com/test_generation/.github/sponsors/speakeasy-light.svg">
		  <source media="(prefers-color-scheme: dark)" srcset="../../github.com/test_generation/.github/sponsors/speakeasy-dark.svg">
		  <img alt="Speakeasy logo" src="../../github.com/test_generation/.github/sponsors/speakeasy-dark.svg" height="100px">
		</picture>
	</a>
</p>
...
<p align="center">
	<a href="https://cybozu.co.jp/?utm_source=oapi-codegen+repo&utm_medium=github+sponsorship">
		<img alt="Cybozu logo" src="../../github.com/test_generation/.github/sponsors/cybozu.svg" height="100px">
	</a>
</p>
...
<p align="center">
	<a href="https://livepeer.org/?utm_source=oapi-codegen+repo&utm_medium=github+sponsorship">
		<picture>
		  <source media="(prefers-color-scheme: light)" srcset="../../github.com/test_generation/.github/sponsors/livepeer-light.svg">
		  <source media="(prefers-color-scheme: dark)" srcset="../../github.com/test_generation/.github/sponsors/livepeer-dark.svg">
		  <img alt="Livepeer logo" src="../../github.com/test_generation/.github/sponsors/livepeer-dark.svg" height="50px">
		</picture>
	</a>
</p>
